...
def tools():
    ...
    if u_inp == "1":
        ...
        print("***********************************************")
        print("Quiting... Thank You for Using our ALPHA - X...!")
        print("***********************************************")
        quit()
    else:
...
def appinstall():
    ...
    if a_inp == "1":
        ...
        print("***********************************************")
        print("Quiting... Thank You for Using our App Installation...!")
        print("***********************************************")
        mainmenu()
        conformation()
    else:
...
def upgrade():
    ...
    if a.lower() == "y":
        ...
        print("****************************************")
        print("Your System is Successfully UPDATED....")
        print("****************************************")
    elif a.lower() == "n":
        mainmenu()
    else:
...
def conformation():
    ...
    if loop.lower() == "y":
        ...
        print("****************************************")
        print("Thank You for Using our ALPHA - X....!")
        print("****************************************")
        quit()
    else:
        print("Enter a Valid Input")
...
def infoconf():
    ...
    if loop.lower() == "y":
        ...
        print("****************************************")
        print("Thank You for Using our INFO - X....!")
        print("****************************************")
    else:
        print("Enter a Valid Input")
        infoconf()
...
def infoxoptions():
    ...
    if i_inp == "1":
        ...
        print("***********************************************")
        print("Quiting... Thank You for Using our INFO - X...!")
        print("***********************************************")
        conformation()
    else:
